...
Ice.loadSlice("-I ./generated/ --all ./generated/LEDArray.ice")
...
class Requires:
    def __init__(self, ice_connector:Ice.CommunicatorI, parameters):
        ...
        self.CameraSimple = self.create_proxy("CameraSimple", RoboCompCameraSimple.CameraSimplePrx, parameters["Proxies"]["CameraSimple"])
        ...
        self.GestorSG = self.create_proxy("GestorSG", RoboCompGestorSG.GestorSGPrx, parameters["Proxies"]["GestorSG"])
        self.LEDArray = self.create_proxy("LEDArray", RoboCompLEDArray.LEDArrayPrx, parameters["Proxies"]["LEDArray"])
        self.Speech = self.create_proxy("Speech", RoboCompSpeech.SpeechPrx, parameters["Proxies"]["Speech"])
...
class Implements:
    def __init__(self, ice_connector:Ice.CommunicatorI, default_handler, parameters):
        ...
        self.juegotrivial = self.create_adapter("JuegoTrivial", juegotrivialI.JuegoTrivialI(default_handler, ""), parameters["Endpoints"]["JuegoTrivial"])
